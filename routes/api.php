...
Route::resource('categories','Category\CategoryController',['except'=>['create','edite']]);
...
////////
Route::resource('users','User\UserController',['except'=>['create','edite']]);
Route::name('verify')->get('users/verify/{token}','User\UserController@verify');
Route::name('resent')->get('users/{user}/resent','User\UserController@resent');
